...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (acct != null) {
            ...
            Log.d("EAG_HOME_ACTIVITY",personName);
            Log.d("EAG_HOME_ACTIVITY",personGivenName);
            Log.d("EAG_HOME_ACTIVITY",personFamilyName);
            Log.d("EAG_HOME_ACTIVITY",personEmail);
            Log.d("EAG_HOME_ACTIVITY",personId);
